        ...
        if not has_file and message.attachments:
            for attachment in message.attachments:
                if attachment.filename.lower().endswith(('.png', '.jpg', '.jpeg', '.gif', '.bmp', 'webp')):
                    ...
                    file_content = f"The user has sent an image file, and the following caption was generated by an AI image-to-text model: [{caption}]. Despite not being able to view the image directly, You will alawys provide a response based on the image context."
                    has_file = True
                    break
