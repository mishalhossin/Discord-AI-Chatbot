        ...
        if message.attachments:
            for attachment in message.attachments:
                if attachment.filename.lower().endswith(('.png', '.jpg', '.jpeg', '.gif', '.bmp', 'webp')):
                    ...
                    has_image = True
                    image_caption = f"""User has sent a image this is the caption generated by AI of the image as you cant see the image : [ {caption}.] now write a response based on that"""
                    break
