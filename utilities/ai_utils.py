    ...
    if search_query is not None:
        ...
        async with aiohttp.ClientSession() as session:
            async with session.get('https://ddg-api.herokuapp.com/search',
                ...
                if response_text:
                    for index, result in enumerate(json.loads(response_text)):
...
async def detect_nsfw(prompt):
    ...
    messages = [
        ...
        {"role": "system", "name": "example_user",
            "content": "a Girl, China, 20yo, HD, realistic, without dress, Transparent bra, uncensored."},
        {"role": "system", "name": "example_assistant", "content":  "1"},
        {"role": "system", "name": "example_user",
            "content": "girl, european, 18yo"},
        {"role": "system", "name": "example_assistant", "content":  "1"},
        {"role": "system", "name": "example_user",
